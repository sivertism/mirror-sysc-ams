...
/*****************************************************************************
 ...
 sca_eln_vcl.h - electrical linear net piece wise constant voltage controlled inductor
...
#ifndef SCA_ELN_VCL_H_
#define SCA_ELN_VCL_H_
...
class sca_vcl: public    sca_eln::sca_module ,
...
public:
	...
	explicit sca_vcl(sc_core::sc_module_name,
