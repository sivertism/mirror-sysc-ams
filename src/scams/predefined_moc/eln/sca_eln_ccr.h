...
/*****************************************************************************
 ...
 sca_eln_ccr.h - electrical linear net piece wise constant current controlled resistor
...
#ifndef SCA_ELN_CCR_H_
#define SCA_ELN_CCR_H_
...
class sca_ccr: public    sca_eln::sca_module ,
...
public:
	...
	explicit sca_ccr(sc_core::sc_module_name,
