...
/*****************************************************************************
 ...
 sca_eln_tdf_c.h - electrical linear net capacitor controlled by a tdf signal
 ...
 SVN Id            :  $Id: sca_eln_tdf_c.h 1892 2016-01-10 11:59:12Z karsten $

 *****************************************************************************/
/*
 * LRM clause 4.3.1.19.
 * The class sca_eln::sca_tdf::sca_c shall implement a primitive module for the
 ...
 * q0 is the initial charge in coulomb, v(p,n)(t) is the voltage across
 ...
 * interpreted as the capacitance in farad.
 */

/*****************************************************************************/

#ifndef SCA_ELN_TDF_C_H_
#define SCA_ELN_TDF_C_H_
