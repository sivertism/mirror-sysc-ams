...
/*****************************************************************************
 ...
 sca_eln_sc_isink.h - electrical linear net converter from current to sc_signal<double>
 ...
 SVN Id            :  $Id: sca_eln_sc_isink.h 1523 2013-02-17 20:36:57Z karsten $

 *****************************************************************************/
/*
 * LRM clause 4.3.1.33.
 * The class sca_eln::sc_core::sca_isink shall implement a primitive module for
 * the ELN MoC that realizes a scaled conversion from an ELN current to a
 * discrete-event output signal. The value of the current flowing through the
 * primitive from terminal p to terminal n shall be scaled with coefficient
 * scale and written to a discrete-event output port outp. The primitive shall
...
#ifndef SCA_ELN_SC_ISINK_H_
#define SCA_ELN_SC_ISINK_H_
