...
/*****************************************************************************
 ...
 sca_eln_vcc.h - electrical linear net piece wise constant voltage controlled resistor
...
#ifndef SCA_ELN_VCR_H_
#define SCA_ELN_VCR_H_
...
class sca_vcr: public    sca_eln::sca_module ,
...
public:
	...
	explicit sca_vcr(sc_core::sc_module_name,
