...
/*****************************************************************************
 ...
 sca_eln_sc_l.h - electrical linear net inductor controlled by a sc_signal<double>
 ...
 SVN Id            :  $Id: sca_eln_sc_l.h 1910 2016-02-16 12:44:37Z karsten $

 *****************************************************************************/
/*
 * LRM clause 4.3.1.28.
 * The class sca_eln::sc_core::sca_l shall implement a primitive module for the
 ...
 * input signal,phi0 is the initial magnetic flux in weber, v(p,n)(t) is the
 * voltage across terminals p and n, and i(p,n)(t) is the current flowing
 * through the primitive from terminal p to terminal n. The product of scale and
 * inp shall be interpreted as the inductance in henry.
 */

/*****************************************************************************/

#ifndef SCA_ELN_SC_L_H_
#define SCA_ELN_SC_L_H_
