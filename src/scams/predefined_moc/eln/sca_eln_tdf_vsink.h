...
/*****************************************************************************
 ...
 sca_eln_tdf_vsink.h - electrical linear net converter from voltage to a tdf signal
 ...
 SVN Id            :  $Id: sca_eln_tdf_vsink.h 1523 2013-02-17 20:36:57Z karsten $

 *****************************************************************************/
/*
 * LRM clause 4.3.1.24.
 * The class sca_eln::sca_tdf::sca_vsink shall implement a primitive module for
 * the ELN MoC that realizes a scaled conversion from an ELN voltage to a
 * TDF output signal. The value of the voltage across terminals p and n shall be
 * scaled with coefficient scale and written to a TDF output port outp. The
 * primitive shall not contribute any equation to the equation system.
 */

/*****************************************************************************/

#ifndef SCA_ELN_TDF_VSINK_H_
#define SCA_ELN_TDF_VSINK_H_
