...
private:
    ...
    void trace_last(long id,const sca_core::sca_time& ct,sca_util::sca_implementation::sca_trace_buffer& tr_buffer);
...
inline void sca_trace_variable<T>::trace_last(
		long id,const sca_core::sca_time& ct,sca_util::sca_implementation::sca_trace_buffer& tr_buffer)
{
