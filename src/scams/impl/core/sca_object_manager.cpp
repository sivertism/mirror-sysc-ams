...
class comp_module_names: public binary_function<sca_module*, const char*, bool>
{
public:
...
sca_module_list_iteratorT sca_object_manager::sca_find_module(const char* name)
{
	...
	instance = find_if(sca_module_list.begin(), sca_module_list.end(), bind2nd(
			comp_module_names(), name));
