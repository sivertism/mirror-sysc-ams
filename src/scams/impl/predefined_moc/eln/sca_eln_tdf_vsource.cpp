...
/*****************************************************************************
  ...
  Created on: 10.11.2009
   ...
   SVN Id            :  $Id: sca_eln_tdf_vsource.cpp 1892 2016-01-10 11:59:12Z karsten $
...
void sca_vsource::trace( sc_core::sc_trace_file* tf ) const
{
	...
	str << "sc_trace of sca_ln::sca_tdf::sca_vsource module not supported for module: " << this->name();
