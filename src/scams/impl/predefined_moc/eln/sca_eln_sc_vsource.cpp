...
/*****************************************************************************
  ...
  sca_eln_sc_vsource.cpp - description
  ...
  Created on: 10.11.2009
   ...
   SVN Id            :  $Id: sca_eln_sc_vsource.cpp 1892 2016-01-10 11:59:12Z karsten $
...
{
	return "sca_eln::sca_de::sca_vsource";
}

void sca_vsource::trace( sc_core::sc_trace_file* tf ) const
{
	std::ostringstream str;
	str << "sc_trace of sca_ln::sca_de::sca_vsource module not supported for module: " << this->name();
...
double sca_vsource::v_t()
{
    ...
    {
    	return scale * conv_port->read();
    }
    else
    {
        double val = scale * sca_ac_analysis::sca_implementation::sca_ac(inp).real();
        return val;
    }
}
