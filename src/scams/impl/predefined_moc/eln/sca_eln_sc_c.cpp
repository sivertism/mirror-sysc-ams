...
/*****************************************************************************
  ...
  Created on: 10.11.2009
   ...
   SVN Id            :  $Id: sca_eln_sc_c.cpp 1892 2016-01-10 11:59:12Z karsten $
...
{
	return "sca_eln::sca_de::sca_c";
}

void sca_c::trace( sc_core::sc_trace_file* tf ) const
{
	std::ostringstream str;
	str << "sc_trace of sca_eln::sca_de::sca_c module not supported for module: " << this->name();
