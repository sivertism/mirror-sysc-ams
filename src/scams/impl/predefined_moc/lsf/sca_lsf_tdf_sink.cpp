...
/*****************************************************************************
  ...
  sca_lsf_tdf_sink.cpp - description
  ...
  Created on: 05.01.2010
   ...
   SVN Id            :  $Id: sca_lsf_tdf_sink.cpp 1376 2012-08-09 08:28:06Z reuther $
...
{
	return "sca_lsf::sca_tdf::sca_sink";
}
...
void sca_sink::assign_result()
{
    ...
    {
        sca_ac_analysis::sca_ac(outp) = scale.get() * sca_lsf::sca_module::x(x);
    }
}
