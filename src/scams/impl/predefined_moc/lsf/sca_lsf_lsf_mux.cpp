...
#else
	add_pwl_b_stamp_to_B(y, x1, ctrl, sca_util::sca_create_pair_vector(threshold.get() - 1.0, 0.0,  threshold.get(), 1.0 ));
	add_pwl_b_stamp_to_B(y, x2, ctrl, sca_util::sca_create_pair_vector(threshold.get() - 1.0, 1.0,  threshold.get(), 0.0 ));
#endif
