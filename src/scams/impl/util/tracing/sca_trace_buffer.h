...
/*****************************************************************************
  ...
  Created on: 13.11.2009
   ...
   SVN Id            :  $Id: sca_trace_buffer.h 1623 2013-09-10 11:26:39Z karsten $
...
class sca_trace_buffer
{
 public:
  ...
  public:
    ...
    {
        if(disabled) return;
        sca_trace_value_handler<T>* vh= new sca_trace_value_handler<T>(value);
        store_abstract_time_stamp(id,ctime,*vh);
    }
  ...
  private:
    ...
    void store_abstract_time_stamp(long id,
                                   const sca_core::sca_time& ctime,
                                   sca_trace_value_handler_base& value);
